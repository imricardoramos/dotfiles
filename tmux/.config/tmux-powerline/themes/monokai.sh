...
if [ -z $TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117" \
		# "date_day 235 136" \
		"tmux_mem_cpu_load 5 0" \
    "disk_usage 5 0 ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD} 33 0 right_enable separator_disable" \
		"date 8 255" \
		"time 8 255 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
	)
fi
